    ...
    <div className="bg-gray-50 min-h-screen py-12">
      <div className="max-w-7xl mx-auto px-4">
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <p className="text-gray-600 mb-8">Elegant footwear for women</p>
        </motion.div>
          ...
          {products.map((product, index) => (
            ...
            >
              <Link to={`/products/${product.id}`}>
                ...
                <div className="p-4">
                  <span className="inline-block bg-pink-100 text-pink-800 text-xs font-semibold px-2.5 py-0.5 rounded-full mb-2">WOMEN</span>
