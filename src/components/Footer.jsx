    ...
    <footer className="bg-gradient-to-b from-gray-900 to-black text-gray-300">
      <div className="container px-6 py-12 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="text-white font-bold text-lg mb-4 border-b-2 border-blue-600 inline-block pb-2">Company</h3>
          ...
          <div>
            <h3 className="text-white font-bold text-lg mb-4 border-b-2 border-blue-600 inline-block pb-2">Blog</h3>
            <ul className="space-y-2">
              <li><Link to="#" className="hover:text-blue-400 transition-colors">Ghana and online businesses</Link></li>
              <li><Link to="#" className="hover:text-blue-400 transition-colors">Customer retention tips</Link></li>
              <li><Link to="#" className="hover:text-blue-400 transition-colors">Dealing with customers</Link></li>
              <li><Link to="#" className="hover:text-blue-400 transition-colors">E-commerce success tips</Link></li>
            </ul>
          </div>

          <div>
            <h3 className="text-white font-bold text-lg mb-4 border-b-2 border-blue-600 inline-block pb-2">Connect</h3>
            <div className="flex gap-3">
              {[
                ...
                <Link key={i} to="#" className="w-10 h-10 flex items-center justify-center border-2 border-gray-600 rounded-full hover:border-blue-400 hover:text-blue-400 transition-all">
      ...
      <div className="border-t border-gray-800 py-6">
        <div className="container mx-auto px-6 flex flex-col sm:flex-row justify-between items-center text-sm">
          <p>© 2024 Olid Consult. All Rights Reserved.</p>
          <p className="mt-2 sm:mt-0">Built with ❤️ in Ghana</p>
        </div>
      </div>
    </footer>
  );
