...
const Footer = () => {
  return (
   ...
   <footer>
        ...
        <div className="-mx-4 flex flex-wrap justify-between">
          <div className="px-4 my-4 w-full xl:w-1/5">
            <Link to={"/"} className="block w-56 mb-10">
              <img src={logo} alt="kanta logo" />
            </Link>
            <p className="text-justify">
              An authentic Ghanaian e-commerce store that provides you with nothing but the best. We offer high quality shoes, both made in Ghana and other foreign brands.
            </p>
          </div>
          ...
          <div className="px-4 my-4 w-full sm:w-auto">
            ...
            <ul className="leading-8">
              <li><Link to={"#"} className="hover:text-blue-400">Ghana and online businesses</Link></li>
              <li><Link to={"#"} className="hover:text-blue-400">What makes your customers stay</Link></li>
              <li><Link to={"#"} className="hover:text-blue-400">Dealing with customers</Link></li>
              <li><Link to={"#"} className="hover:text-blue-400">5 Tips to own a 10k e-commerce Website</Link></li>
              <li><Link to={"#"} className="hover:text-blue-400">See More</Link></li>
            </ul>
          </div>
          <div className="px-4 my-4 w-full sm:w-auto xl:w-1/5">
            ...
            <Link to={"#"} className="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full mr-1 hover:text-blue-400 hover:border-blue-400">
            ...
            <Link to={"#"} className="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full hover:text-blue-400 hover:border-blue-400">
    ...
    <div className="bg-black border-t border-white py-4 text-gray-100">
      <div className="container mx-auto px-4">
        <div className="-mx-4 flex flex-wrap justify-between">
          <div className="px-4 w-full text-center sm:w-auto sm:text-left">
            Copyright © 2024 Olid Consult. All Rights Reserved.
          </div>
          <div className="px-4 w-full text-center sm:w-auto sm:text-left">
            Olid Consult
          </div>
